                ...
                <div class="card-body">
                    <form action="" method="POST">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?= (form_error('nama_kriteria')) ? 'border border-danger' : 'border border-secondary' ?>" id="nama_kriteria " name="nama_kriteria" value="<?= $kriteria['nama_kriteria']  ?>" autocomplete="off">
                            <?= form_error('nama_kriteria', '<small class="form-text text-danger">', '</small>'); ?>
                        </div>
                        <div class="form-group">
                            <label for="alias">Alias</label>
                            <input type="text" class="form-control <?= (form_error('alias')) ? 'border border-danger' : 'border border-secondary' ?>" id="alias " name="alias" value="<?= $kriteria['alias'];  ?>" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control selectpicker <?= (form_error('jenis_kriteria')) ? 'border border-danger' : 'border border-secondary' ?>" id="jenis_kriteria" name="jenis_kriteria" title="Pilih Jenis Kriteria">
                                <?php if ($kriteria['jenis_kriteria'] == 'Cost') : ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control <?= (form_error('bobot_kriteria')) ? 'border border-danger' : 'border border-secondary' ?>" id="bobot_kriteria " name="bobot_kriteria" value="<?= $kriteria['bobot_kriteria'] ?>" autocomplete="off">
