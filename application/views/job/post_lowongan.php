        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="bradcam_text">
                    <h3 class="text-center text-uppercase">POST LOWONGAN KERJA</h3>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="single_candidates  shadow-sm p-3 mb-5 bg-white rounded p-5">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label for="nama_alternatif">Nama Lowongan Kerja</label>
                        ...
                        <button type="submit" class="btn btn-primary mb-3 mt-3">Simpan Data Lowongan Kerja</button>
                    </div>
